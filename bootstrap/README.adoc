...
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/namespace[kubernetes_namespace.namespace] (resource)
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/secret_v1[kubernetes_secret_v1.avp_config] (resource)
...
==== [[input_avp_config]] <<input_avp_config,avp_config>>
...
|[[input_avp_config]] <<input_avp_config,avp_config>>
|Backend config of ArgoCD Vault plugin.
|`any`
|`null`
|no
